...
* Amazon Elastic Compute Cloud (Amazon EC2) instances that provide the Spot Elastigroup with Intelligent Traffic Flow and Predictive Autoscaling features enabled.
